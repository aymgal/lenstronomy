...
class Param(object):
    ...
    def __init__(self, kwargs_model,
                 ...
                 num_point_source_list=None, image_plane_source_list=None, solver_type='NONE', 
                 Ddt_sampling=None, Dd_sampling=None, source_size=False):
        """
        ...
        self.cosmoParams = CosmoParam(Ddt_sampling=Ddt_sampling, Dd_sampling=Dd_sampling, mass_scaling=self._mass_scaling,
